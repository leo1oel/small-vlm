...
def load_model(cfg: DictConfig) -> None:
    log.info(f"Loading model: [bold yellow on white]{cfg.model.name}[/bold yellow]")
    log.info(f"Visual encoder: [bold cyan on white]{cfg.model.visual_encoder.name}[/bold cyan]")
