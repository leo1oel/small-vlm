...
from .config.config_schema import AppConfig, ModeConfig, ModelConfig, DatasetConfig, TrainerConfig, register_configs
...
def main(cfg: AppConfig) -> None:
    cfg = OmegaConf.create(OmegaConf.to_object(cfg), schema=AppConfig)
    vlm(cfg)
