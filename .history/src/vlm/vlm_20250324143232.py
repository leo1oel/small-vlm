...
def load_model(cfg: DictConfig) -> None:
    log.info(f"Loading model: [red][link=file:///path/to/conf/model/default.yaml]Example[/link][/red]")
    log.info(f"Visual encoder: [bold cyan]{cfg.model.visual_encoder.name}[/bold cyan]")
