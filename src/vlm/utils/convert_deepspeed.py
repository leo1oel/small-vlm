...
def convert_checkpoint():
    ...
    try:
        result = convert_zero_checkpoint_to_fp32_state_dict(
            checkpoint_dir="/pasteur2/u/yuhuiz/yiming/small-vlm/outputs/2025-04-03/08-06-48/checkpoints/last.ckpt",
            output_file="/pasteur2/u/yuhuiz/yiming/small-vlm/outputs/2025-04-03/08-06-48/checkpoints/model.pt",
        )
